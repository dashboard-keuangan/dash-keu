    ...
    <section id="wrapper" class="login-register login-sidebar"  style="background-image:url(<?=base_url()?>assets/images/background/login-register.jpg);">
      <div class="login-box card">
        <div class="card-body">
          ...
          <?php } ?>
          <form class="form-horizontal form-material" id="loginform" action="<?=base_url('auth/act_login')?>" method="POST">
            ...
            <div class="form-group m-b-0">
              <div class="col-sm-12 text-center">
                <p>Don't have an account? <a href="<?=base_url('auth/register')?>" class="text-primary m-l-5"><b>Sign Up</b></a></p>
              </div>
            </div>
          </form>
